...
function AppProvider({ children }) {
    ...
    const addTransactionFromFile = async ({ category, file }) => {
        try {
            const formData = new FormData();
            formData.append("category", category);
            formData.append("file", file);

            // Do NOT manually set Content-Type: axios/browser will set boundary for multipart/form-data
            ...
            toast.success("Receipt uploaded and parsed");
            return data; // backend response (contains parsed transaction)
        } catch (err) {
